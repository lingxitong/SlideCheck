...
# This file now internally uses the slidecheck library
...
from slidecheck.models.slidecheck import SlideCheckOutput as ModelOutput
from slidecheck.models.slidecheck import SlideCheckMLP, SlideCheckConcatV2
...
class BaseDualHeadModel(nn.Module, ABC):
    ...
    New code should use slidecheck.models directly.
    """
    tag: str = "base"
...
# -------------------------
# Model variants (using slidecheck library)
# -------------------------
...
class DualHeadMLP_v1(BaseDualHeadModel):
    ...
    NOTE: This now wraps SlideCheckMLP from the slidecheck library.
    """
    def __init__(self, in_dim: int, hidden_dim: int = 512, dropout: float = 0.1):
        super().__init__(in_dim)
        # Use slidecheck library implementation
        self._model = SlideCheckMLP(in_dim=in_dim, hidden_dim=hidden_dim, dropout=dropout)
...
class MobileNetV3DualHead(BaseDualHeadModel):
    ...
    def __init__(self, in_dim: int = None, hidden_dim: int = 512, dropout: float = 0.1,
        ...
        # Use mlp_v1 structure as classification head
