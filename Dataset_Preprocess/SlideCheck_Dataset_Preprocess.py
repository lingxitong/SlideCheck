...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_csv', type=str, 
                        default='Dataset_Preprocess/example_dataset/CRC_100K/CRC-100K.csv',
                        help='Path to dataset CSV file')
    parser.add_argument('--dataset_class_csv', type=str, 
                        default='Dataset_Preprocess/example_dataset/CRC_100K/CRC-100K-Class.csv',
