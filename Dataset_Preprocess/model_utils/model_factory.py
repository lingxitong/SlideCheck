...
class Conchv1InferenceEncoder(BasePatchEncoder):
    ...
    def _build(self, with_proj=False, normalize=False):
        ...
        try:
            from .model_zoo.conch.open_clip_custom import create_model_from_pretrained
        except:
            traceback.print_exc()
        ...
        from .model_zoo.conch.open_clip_custom import get_tokenizer
...
class Phikonv2InferenceEncoder(BasePatchEncoder):
    ...
    def _build(self):
        ...
        eval_transform = T.Compose([
            ...
            T.CenterCrop(224),  
            T.ToTensor(),
            T.Normalize(mean=KAIKO_MEAN, std=KAIKO_STD)  # Normalize with mean=0.5, std=0.5
        ])
...
class Conchv15InferenceEncoder(BasePatchEncoder):
    ...
    def _build(self, img_size=448):
        from .model_zoo.conchv1_5.conchv1_5 import create_model_from_pretrained
        ...
        from .model_zoo.conchv1_5.conch_tokenizer import Conch_Tokenizer
